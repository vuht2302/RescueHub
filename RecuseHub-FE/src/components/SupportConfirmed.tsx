...
export const SupportConfirmed: React.FC<SupportConfirmedProps> = ({ onViewChange }) => {
  return (
      ...
      >
        <div className="bg-surface-container-lowest rounded-xl shadow-[0_12px_32px_rgba(0,31,42,0.08)] p-12 flex flex-col items-center text-center">
          <div className="mb-8 relative">
            <div className="w-24 h-24 rounded-full bg-primary/10 flex items-center justify-center">
              <CheckCircle2 className="text-primary" size={64} fill="currentColor" />
            </div>
          </div>

          <h1 className="font-headline font-extrabold text-4xl text-on-surface mb-3 tracking-tight">Support is Confirmed</h1>
          <p className="text-on-surface-variant text-lg max-w-md mb-10 leading-relaxed">
            Dispatch has received your signal. Our nearest response unit is currently navigating to your coordinates.
          </p>
          ...
          <div className="w-full bg-surface-container-low rounded-lg p-6 mb-10 flex items-center justify-between text-left">
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="block font-headline font-bold text-on-surface leading-none">Response Unit Active</span>
                <span className="text-sm text-on-surface-variant">ETA: Under 12 minutes</span>
              </div>
            </div>
          ...
          <div className="w-full mb-10 text-left">
            ...
            <textarea 
              ...
              placeholder="Any specific details for the rescue team? (e.g. visibility, terrain, hazards)" 
              rows={3}
            />
          </div>
        ...
        <div className="mt-8 flex justify-center gap-12 text-on-surface-variant/60">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Haptic Alert Enabled</span>
          </div>
        </div>
      </motion.main>
    </div>
