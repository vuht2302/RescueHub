...
import {
  Warehouse, Package, Box, ArrowRightLeft, Truck, Home, PackagePlus, Database,
} from "lucide-react";
...
const TABS: Tab[] = [
  { id: "warehouse", label: "Kho hàng", shortLabel: "Kho", icon: Warehouse, description: "MAN-01 — Quản lý danh mục kho" },
  { id: "stock", label: "Tồn kho", shortLabel: "Tồn kho", icon: Database, description: "MAN-02 — Xem tình trạng tồn kho theo thời gian thực" },
  { id: "item", label: "Hàng hóa", shortLabel: "Hàng", icon: Package, description: "MAN-03 — Danh mục hàng hóa cứu trợ" },
...
export const InventorySection: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Page Header */}
      <div>
        <h2 className="text-2xl font-black text-gray-900" style={{ fontFamily: "var(--font-primary)" }}>
          Quản lý kho
        </h2>
